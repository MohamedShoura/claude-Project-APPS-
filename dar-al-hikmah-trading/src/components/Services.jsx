  ...
  return (
    <section id="services" className="py-24 bg-section-green relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="mt-16 relative overflow-hidden rounded-3xl min-h-64">
          <img
          ...
          <div className="absolute inset-0 bg-black/80 flex items-center justify-center">
            <div className="text-center px-6 sm:px-14 max-w-2xl">
              <h3 className="text-2xl sm:text-3xl font-black text-white mb-3">
                {T.bannerTitle1}<span className="text-gold-gradient">{T.bannerTitle2}</span>
              </h3>
              <p className="text-gray-300 mb-6">{T.bannerText}</p>
              <button
